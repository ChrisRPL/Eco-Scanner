            ...
            children: <Widget>[
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    "Couldn't load the product resources :(",
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: <Widget>[
                                  ...
                                  Text(
                                    widget.isCruelty
                                        ? "Oooppss! Your product could be tested on animals! Company " +
                                            widget.companyName +
                                            " which owns that product tests its products on animals!"
                                        : "But your product has not been found in \"animal-tested\" list, it's cruelty-free! :)",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                        fontFamily: "OpenSans",
                                        fontWeight: FontWeight.normal,
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Card(
                              ...
                              elevation: 8,
                              color:
                                  widget.isCruelty ? Colors.red : Colors.green,
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Column(
                                  children: <Widget>[
              ...
              widget.imageUrl == ""
                  ? RaisedButton.icon(
                      ...
                      label: Text("Add product data yourself",
                          style: TextStyle(
                              fontFamily: "OpenSans",
                              fontSize: 16,
                              fontWeight: FontWeight.normal,
                  ...
                  : RaisedButton.icon(
                      ...
                      label: Text("Add product to list",
                          style: TextStyle(
                              fontFamily: "OpenSans",
                              fontSize: 16,
                              fontWeight: FontWeight.normal,
