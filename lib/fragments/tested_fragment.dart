    ...
    if (connectivityResult == ConnectivityResult.none) {
      showDialog(
          ...
          builder: (ctx) => CustomDialog(
                ...
                title: "Oooppsss!",
                description:
                    "It seems like you are not connected to a network! Some information will not be able to be properly loaded!",
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  all
                      ...
                      : tested
                          ? list = snapshot.data
                              .where((element) => element.isCruelty == 1)
                              .toList()
                          : list = snapshot.data
                              .where((element) => element.isCruelty == 0)
                              .toList();
                      ...
                      ? ListView.builder(
                          itemCount: all
                              ...
                              : tested
                                  ? snapshot.data
                                      .where(
                                          (element) => element.isCruelty == 1)
                                      .toList()
                                      .length
                                  : snapshot.data
                                      .where(
                                          (element) => element.isCruelty == 0)
                                      .toList()
                                      .length,
                                  ...
                                  child: Material(
                                    ...
                                    child: InkWell(
                                      ...
                                      child: ListTile(
                                        ...
                                        subtitle: list[index].companyName !=
                                                null
                                            ? Text(list[index].companyName,
                                                style: TextStyle(
                                                    fontFamily: "OpenSans",
                                                    fontSize: 10,
                                                    fontWeight:
    ...
    return Scaffold(
      ...
      body: Builder(
        builder: (ctx) => Container(
            color: Colors.lightGreen, child: _buildProductsList(context)),
      ),
    );
  }
}
