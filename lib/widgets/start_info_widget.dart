      ...
      child: Card(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Center(
                child: Text(
              "Why to choose cruelty-free products?:",
              textAlign: TextAlign.center,
              style: TextStyle(
                  fontFamily: "OpenSans",
            ...
            Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Text(
                    " Products like this are better for our planet",
            ...
            Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Text(
                    " Animal testing harms the animals",
                    textAlign: TextAlign.left,
                    style: TextStyle(
                        fontFamily: "OpenSans", fontWeight: FontWeight.w300),
                  )
            ...
            Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  Icon(Icons.insert_emoticon),
                  Text(
                    " Cruelty-free products use less chemicals",
                    textAlign: TextAlign.left,
                    style: TextStyle(
                        fontFamily: "OpenSans", fontWeight: FontWeight.w300),
                  )
            ...
            Padding(
              padding: const EdgeInsets.only(
                  right: 3.0, left: 3.0, top: 3.0, bottom: 10.0),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: <Widget>[
                  Icon(Icons.sentiment_very_dissatisfied),
